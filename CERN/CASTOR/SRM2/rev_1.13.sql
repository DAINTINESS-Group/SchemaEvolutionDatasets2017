...
CREATE TABLE StageRequest (requestDesc VARCHAR2(2048), castorReqId VARCHAR2(2048), overwriteOption NUMBER, protocol VARCHAR2(2048), euid NUMBER, egid NUMBER, id INTEGER PRIMARY KEY, srmUser INTEGER, requestType INTEGER) INITRANS 50 PCTFREE 50;
...
CREATE TABLE UserFile (castorFileName VARCHAR2(2048), fileSize INTEGER, id INTEGER PRIMARY KEY, srmUser INTEGER, ownerPermission INTEGER, otherPermission INTEGER, status INTEGER) INITRANS 50 PCTFREE 50;
...
CREATE TABLE SubRequest (spaceToken VARCHAR2(2048), turl VARCHAR2(2048), expirationInterval NUMBER, id INTEGER PRIMARY KEY, request INTEGER, userFile INTEGER, status INTEGER) INITRANS 50 PCTFREE 50;
