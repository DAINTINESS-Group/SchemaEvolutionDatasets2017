...
CREATE TABLE UserFile (castorFileName VARCHAR2(2048), fileSize NUMBER, lifeTime NUMBER, spaceToken VARCHAR2(2048), id INTEGER PRIMARY KEY, srmUser INTEGER, ownerPermission INTEGER, otherPermission INTEGER, status INTEGER) INITRANS 50 PCTFREE 50;
