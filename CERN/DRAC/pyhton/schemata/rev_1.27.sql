...
INSERT INTO user (Host,User,Password) VALUES('%','Dirac',PASSWORD ('lhcbMySQL'));
INSERT INTO user (Host,User,Password) VALUES('localhost','Dirac',PASSWORD ('lhcbMySQL'));
INSERT INTO user (Host,User,Password) VALUES('lxgate14.cern.ch','Dirac',PASSWORD ('lhcbMySQL'));
-- GRANT SELECT,INSERT,LOCK TABLES,UPDATE,DELETE,CREATE,DROP,ALTER ON dirac.* TO Dirac IDENTIFIED BY 'lhcbMySQL';
GRANT SELECT,INSERT,LOCK TABLES,UPDATE,DELETE,CREATE,DROP,ALTER ON JobDB.* TO Dirac IDENTIFIED BY 'lhcbMySQL';
-- GRANT SELECT,INSERT,LOCK TABLES,UPDATE,DELETE,CREATE,DROP,ALTER ON test.* TO Dirac IDENTIFIED BY 'lhcbMySQL';
-- 
