...
CREATE TABLE StageRequest (requestDesc VARCHAR2(2048), expirationTime INTEGER, expirationInterval NUMBER, castorReqId VARCHAR2(2048), lifetimeUpdates NUMBER, overwriteOption NUMBER, id INTEGER PRIMARY KEY, srmUser INTEGER, requestType INTEGER, status INTEGER) INITRANS 50 PCTFREE 50;
...
CREATE TABLE UserFile (castorFileName VARCHAR2(2048), fileSize INTEGER, lifeTime NUMBER, spaceToken VARCHAR2(2048), id INTEGER PRIMARY KEY, srmUser INTEGER, ownerPermission INTEGER, otherPermission INTEGER, status INTEGER) INITRANS 50 PCTFREE 50;
...
CREATE TABLE StorageRequest (requestDesc VARCHAR2(2048), expirationTime INTEGER, expirationInterval NUMBER, castorReqId VARCHAR2(2048), spaceToken VARCHAR2(2048), tokenDescription VARCHAR2(2048), storageAllocated NUMBER, storageUsed NUMBER, storageLifetime NUMBER, numberOfUpdates NUMBER, id INTEGER PRIMARY KEY, srmUser INTEGER, requestType INTEGER, status INTEGER, storageStatus INTEGER) INITRANS 50 PCTFREE 50;
