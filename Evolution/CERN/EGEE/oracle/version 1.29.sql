...
-- The time that the job was submitted
  ,submit_time      	TIMESTAMP WITH TIME ZONE DEFAULT SYSTIMESTAMP
--
...
--
-- trace timestamp
   ,trace_timestamp     TIMESTAMP WITH TIME ZONE DEFAULT SYSTIMESTAMP
--
-- trace content
   ,content             CLOB
-- 
...
--
DROP TABLE t_agent CASCADE CONSTRAINTS;
...
-- 'channel:<channel_name>'
   agent_name           VARCHAR2(255)
			CONSTRAINT agent_agent_name_not_null NOT NULL
                        CONSTRAINT agent_agent_name_pk PRIMARY KEY
--
-- The agent DN
   ,agent_dn            VARCHAR2(1024)
--
-- The name of the host where the agent is installed
   ,agent_host          VARCHAR2(255)
--
...
INSERT INTO t_schema_vers (major,minor,patch) VALUES (2,0,1);
