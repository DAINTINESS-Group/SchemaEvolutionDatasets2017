...
INSERT INTO CastorVersion VALUES ('-', '2_1_7_27');
...
/*******************************************************************
 *
 * @(#)RCSfile: oracleCommon.sql,v  Revision: 1.665.2.6  Date: 2009/01/27 16:32:47  Author: waldron 
 *
...
/*******************************************************************
 *
 * @(#)RCSfile: oraclePerm.sql,v  Revision: 1.646.2.1  Date: 2008/09/22 13:15:52  Author: waldron 
 *
...
/*******************************************************************
 *
 * @(#)RCSfile: oracleStager.sql,v  Revision: 1.674.2.8  Date: 2008/11/24 18:41:15  Author: waldron 
 *
 ...
 * is declared Tape0 and the given file class asks for tape copies.
 * Returns 1 in such a case, 0 else
 */
...
BEGIN
  ...
  EXCEPTION WHEN NO_DATA_FOUND THEN
    ...
    INSERT INTO CastorFile (id, fileId, nsHost, svcClass, fileClass, fileSize,
      ...
      VALUES (ids_seq.nextval, fId, nsHostName, sc, fc, fs, getTime(), getTime(), REGEXP_REPLACE(fn,'(/){2,}','/'))
...
/*******************************************************************
 *
 * @(#)RCSfile: oracleJob.sql,v  Revision: 1.656.2.4  Date: 2008/10/17 12:47:24  Author: waldron 
 *
...
/*******************************************************************
 *
 * @(#)RCSfile: oracleQuery.sql,v  Revision: 1.642.2.1  Date: 2008/11/24 18:40:01  Author: waldron 
 *
 * PL/SQL code for the stager and resource monitoring
 *
 * @author Castor Dev team, castor-dev@cern.ch
...
/*******************************************************************
 *
 * @(#)RCSfile: oracleTape.sql,v  Revision: 1.675.2.11  Date: 2008/12/03 17:03:47  Author: itglp 
 *
...
/*******************************************************************
 *
 * @(#)RCSfile: oracleGC.sql,v  Revision: 1.660.2.5  Date: 2008/11/24 18:39:21  Author: waldron 
 *
