...
INSERT INTO CastorVersion VALUES ('-', '2_1_3_22');

/*******************************************************************
 *
 * @(#)RCSfile: oracleTrailer.sql,v  Revision: 1.441.2.7  Date: 2007/07/13 15:53:41  Author: sponcec3 
 *
  ...
  ELSE
	...
	-- We will tell the client that the file is unavailable
        ...
        IF (stat.count() > 0) THEN
          ...
          UPDATE SubRequest SET status = 7 WHERE id = rsubreqId; -- FAILED
          COMMIT;
        ELSE
