...
CREATE TABLE SubRequest (spaceToken VARCHAR2(2048), turl VARCHAR2(2048), expirationInterval INTEGER, castorFileName VARCHAR2(2048), reservedSize INTEGER, svcClass VARCHAR2(2048), reason VARCHAR2(2048), errorCode NUMBER, id INTEGER PRIMARY KEY, request INTEGER, status INTEGER) INITRANS 50 PCTFREE 50;
...
/*******************************************************************
 *
 * @(#)RCSfile: oracleTrailer.sql,v  Revision: 1.13  Release Date: 2007/02/22 09:32:42  Author: itglp 
 *
...
INSERT INTO CastorVersion VALUES ('2_1_2_4', 'Revision: 1.13  Date: 2007/02/22 09:32:42 ');
