...
INSERT INTO CastorVersion VALUES ('-', '2_7_2');

/*******************************************************************
 *
 * @(#)RCSfile: oracleTrailer.sql,v  Revision: 1.33  Release Date: 2008/07/07 09:53:45  Author: itglp 
 *
...
BEGIN
  ...
  bulkDelete('SELECT SubRequest.id FROM SubRequest, CleanupReqHelper R
               WHERE SubRequest.request = R.id;', 'SubRequest');
